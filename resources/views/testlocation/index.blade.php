...
<div class="row">
		<div class="col-lg-12">
				<h1 class="page-header">Lokasi Tes</h1>
		</div>
		<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
				...
				<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="col-md-2 col-md-offset-5">
								<a class="btn btn-success" href="{!! URL::to('admin/testlocations/create') !!}"><i class="fa fa-floppy-o fa-fw"></i> Tambah Lokasi Tes</a>
							</div>
...
<!-- 													<td>
													...
													<td class="center col-md-2">
															...
															&nbsp;&nbsp;
															<a class="btn btn-xs btn-danger" href="{!! URL::to('admin/testlocations/'.$location->id) !!}" data-token="{{csrf_token()}}" data-method="delete" data-confirm="Anda yakin menghapus data Lokasi Tes?"><i class="fa fa-remove fa-fw"></i> Hapus</a>
													</td>
												</tr>
													@endforeach
											</tbody>
