...
<div class="row">
		<div class="col-lg-12">
				<h1 class="page-header">Tahun Lulus</h1>
		</div>
		<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
											...
											<tbody>
												...
												<tr>
													...
													<td class="center col-md-2">
															<a class="btn btn-xs btn-success" href="{!! URL::to('admin/tahunlulus/'.$grad->id.'/edit') !!}"><i class="fa fa-edit fa-fw"></i> Edit</a>
													</td>
												</tr>
												@endforeach
											</tbody>
