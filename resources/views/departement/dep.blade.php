				...
				<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="col-md-2 col-md-offset-5">
								<a class="btn btn-success" href="{!! URL::to('/departements/create') !!}"><i class="fa fa-floppy-o fa-fw"></i> Tambah Jurusan</a>
							</div>
											...
											<tbody>
												...
												<tr>
													...
													<td class="center col-md-2">
															<a class="btn btn-xs btn-success" href="{!! URL::to('departements/'.$depart->id.'/edit') !!}"><i class="fa fa-edit fa-fw"></i> Edit</a>
															&nbsp;&nbsp;
															<a class="btn btn-xs btn-danger" href="{!! URL::to('departements/'.$depart->id) !!}" data-token="{{csrf_token()}}" data-method="delete" data-confirm="Anda yakin menghapus data Jurusan?"><i class="fa fa-remove fa-fw"></i> Hapus</a>
													</td>
												</tr>
													@endforeach
											</tbody>
